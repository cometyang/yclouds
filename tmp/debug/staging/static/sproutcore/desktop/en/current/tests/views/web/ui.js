...
(function() {
  ...
  .add("basic", SC.WebView, {
    ...
    value: '/static/sproutcore/desktop/en/current/debug/iframe.html?1262955016',
  ...
  function() {
    ...
    */
    SC.RunLoop.begin();
    view.set('value', '/static/sproutcore/desktop/en/current/debug/iframe.html?1262955016');
    SC.RunLoop.end();
    stop();
    SC.Event.add(view.$('iframe')[0], 'load', this,
    function() {
