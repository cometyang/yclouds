...
module("SC.Request", {
  ...
  setup: function() {
    url = '/static/sproutcore/foundation/en/current/fixtures/file_exists.json?1262955016'; //"/static/sproutcore/en/desktop/_src/desktop.platform/english.lproj/file_exists.json" ;
...
test("Test auto-deserializing malformed JSON", function() {
  request = SC.Request.getUrl('/static/sproutcore/foundation/en/current/fixtures/malformed.json?1262955016').set('isJSON', YES);
