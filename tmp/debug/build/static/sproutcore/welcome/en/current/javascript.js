/* >>>>>>>>>> BEGIN bundle_info.js */
        ;(function() {
          ...
          SC.BUNDLE_INFO[target_name] = {
            ...
            styles:   ['/static/sproutcore/standard_theme/en/current/stylesheet.css?1262955016'],
            scripts:  []
          }
        })();
    ...
    contentView: SC.View.design({
      ...
      icon: SC.View.design({
        ...
        render: function(context, firstTime) {
          context.attr('src', '/static/sproutcore/foundation/en/current/images/sproutcore-logo.png?1262955016');
        }
      }),
